...
@Singleton
@Startup
public class VesselPortInitiatorStatic implements VesselPortInitiator {
    final static Logger LOG = LoggerFactory.getLogger(VesselPortInitiatorStatic.class);

    @EJB
    ParameterService parameterService;
    
    private VesselPortType vesselPort;
